 ...
 *         &lt;element name="userlocation" type="{}tuserlocation" maxOccurs="unbounded" minOccurs="0"/>
...
public class EStatusReturn {
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the userlocation property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     * getUserlocation().add(newItem);
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Tuserlocation }
     */
    public List<Tuserlocation> getUserlocation() {
        if (userlocation == null) {
            userlocation = new ArrayList<Tuserlocation>();
        }
